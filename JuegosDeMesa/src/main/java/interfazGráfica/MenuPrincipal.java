...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1Ingresar.setText("Ingresar Juego o expansión");
        ...
        jButton1Buscar.setText("Buscar juego");
        ...
        jButton2.setText("Eliminar Juego");
        ...
        jButton3.setText("Total de juegos");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jButton1Ingresar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jButton1Buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton1IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1IngresarActionPerformed
        ...
        IngresarJuego l = new IngresarJuego(this, true);
    ...
    private void jButton1BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1BuscarActionPerformed
        ...
        try {
            Buscar2 l = new Buscar2(this, true);
            l.setLocationRelativeTo(null);
            l.setVisible(true);
...
//        try {
//            BuscarJuego l = new BuscarJuego(this, true);
//            l.setLocationRelativeTo(null);
//            l.setVisible(true);
//        } catch (ExcepcionMia ex) {
//            Logger.getLogger(MenuPrincipal.class.getName()).log(Level.SEVERE, null, ex);
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Modificar2 l = new Modificar2(this, true);
            l.setLocationRelativeTo(null);
            l.setVisible(true);
        } catch (ExcepcionMia ex) {
            Logger.getLogger(MenuPrincipal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Eliminar l = new Eliminar(this, true);
        l.setLocationRelativeTo(null);
        l.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            TotalDeJuegos l = new TotalDeJuegos(this, true);
            l.setLocationRelativeTo(null);
            l.setVisible(true);
        } catch (ExcepcionMia ex) {
            Logger.getLogger(MenuPrincipal.class.getName()).log(Level.SEVERE, null, ex);
